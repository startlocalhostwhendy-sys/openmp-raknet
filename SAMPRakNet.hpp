...
public:
	...
	static bool ShouldLogSyncOrRPCPacket(uint8_t packetId);
	...
	static void SetVerboseNetworkLogs(bool value) { verboseNetworkLogs_ = value; }
	static bool IsVerboseNetworkLogs() { return verboseNetworkLogs_; }
	...
	static void SetTempConnectionProtection(bool value) { tempConnectionProtection_ = value; }
	static bool IsTempConnectionProtectionEnabled() { return tempConnectionProtection_; }
...
private:
	...
	static bool verboseNetworkLogs_;
	static bool tempConnectionProtection_;
	static ICore* core_;
